...
<AnimatePresence>
  {sidebarOpen && (
    <>
      ...
      <motion.aside
        ...
        className="fixed top-0 left-0 bottom-0 w-72 bg-darker border-r border-border z-50 p-5 md:hidden overflow-y-auto"
      >
        ...
        <div className="space-y-5">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-primary rounded-lg text-white"
          >
  ...
  >
    <Menu className="w-6 h-6 text-white" />
          ...
          <div className="hidden md:flex md:items-center justify-between gap-3 mt-4">
