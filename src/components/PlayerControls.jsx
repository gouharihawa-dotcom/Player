     ...
     <div className="flex items-center justify-between gap-0.5">
       ...
       <div className="flex items-center gap-1 sm:gap-2">
          <div className="relative">
            ...
            {showSpeedMenu && (
              <div className="absolute bottom-[20px] mb-2 right-0 bg-surface-light border border-border rounded-lg shadow-xl overflow-hidden  min-w-[80px] z-20">
                {speeds.map((s) => (
                  <button
                    key={s}
                    onClick={() => {
                    ...
                    className={`w-full px-0.5 py-0 text-sm transition-colors ${
                      playbackRate === s
